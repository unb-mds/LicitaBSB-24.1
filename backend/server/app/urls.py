...
from app.views import  listar_licitacoes,licitacao_por_id,nome_orgaos_por_id, listar_orgaos, listar_licitacoes_quantidade_mensal, listar_licitacoes_quantidade_anual, listar_licitacoes_valores_mensais, listar_licitacoes_valores_anuais
