...
json_path = '/home/victor-schmidt/Documents/forks/LicitaBSB-24.1/backend/colecao_de_dados/database/data_avisos.json'
...
def insert_data(data, cursor):
    ...
    cursor.execute("""
        INSERT INTO app_licitacao (
            ...
            assinante, data, cargo, edicao, secao_pagina, link, id
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (
