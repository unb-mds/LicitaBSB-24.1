...
export default function BiddingPage() {
  ...
  const tituloLicitacao =
    'nomeOrgao' in licitacao ? licitacao['nomeOrgao'] : licitacao['Nome_UG'];
  ...
  const valorLicitacao =
    'Valor_Licitacao' in licitacao
  ...
  return (
    <div className={styles.biddingContainer}>
      <div>
        ...
        <div>{/* LINKS PARA COMPARTILHAMENTO */}</div>
      </div>
      <div>
